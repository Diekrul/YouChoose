...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="index.html<?php url() ?>">Home</a></li>
    ...
    <div id="templatemo_main">
    	<div id="sidebar" class="float_l">
            ...
            <div class="sidebar_box"><span class="bottom"></span>
            	<h3><a class="sidebar_box_icon" href="http://es.hiresimage.com" title="Imagen de alta resolución"  target="_blank"><img src="images/templatemo_sidebar_header.png" alt="Imagen de alta resolución" title="Imagen de alta resolución from es.hiresimage.com" /></a>Bestsellers </h3>   
                <div class="content"> 
                	<div class="bs_box">
