...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menubar">
        <div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="empresa.php<?php url() ?>">Inicio</a></li>
 ...
 <table width="680px" cellspacing="0" cellpadding="5">
                      <tr bgcolor="#ddd">
                        ...
                        <tr>
                            <td><img src="images/product/05.jpg" alt="image 1" /></td> 
                            <td>Notebook </td> 
                    ...
                    <div class="cleaner h30"></div>
                        ...
                        <p>Procesador Máx Intel® Core™2 Duo Processor T9600 <br/>Sistema Operativo Windows Vista® Home Premium Original <br/>
                        <br/>Velocidad Máx (GHz) 2.8<br/> FSB Máx (MHz) 1066<br/>Memoria Caché (MB) 6<br/>ChipSet Principal Intel PM45 / GM45<br/>Memoria RAM Máx (MB) 4096<br/>
                        <br/>Tiop Memoria RAM DDR3 1066 Mhz + Intel® Turbo Memory 1.6 (4GB)<br/> Capacidad Disco Duro Máx (GB) 320<br/>Lector de Tarjetas 6-in-1 (xD/SD/MMC/MMC Plus/MS/MS Pro) <br/>
                        <br/>Dispositivo Óptico SATA DVD Super Multi Dual Layer (DVD-R/RW, +R/RW, RAM)<br/>Tarjeta Gráfica (MB)Hasta NVIDIA® GeForce® 9600M GT (GDDR3 512MB VRAM, *TurboCache Suppor <br/></p> 
