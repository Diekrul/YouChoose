...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
    	<div id="sidebar" class="float_l">
            ...
            <div class="sidebar_box"><span class="bottom"></span>
            	<h3><a class="sidebar_box_icon" href="http://es.hiresimage.com" title="imágenes de Creative commons"  target="_blank"><img src="images/templatemo_sidebar_header.png" alt="imágenes de Creative commons from es.hiresimage.com" title="imágenes de Creative commons" /></a>Bestsellers </h3>   
                <div class="content"> 
                	<div class="bs_box">
