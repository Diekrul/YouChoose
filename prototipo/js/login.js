    ...
    $.ajax({
        ...
        success: function (data)
        {
			if(data.length > 2){
				...
				if(cliente_o_usuario){
					//soy empresa
					window.location="http://localhost:8000/sitios/YouChoose/prototipo/empresa.php?name="+data;
				}else{
					window.location="http://localhost:8000/sitios/YouChoose/prototipo?name="+data;
				}
